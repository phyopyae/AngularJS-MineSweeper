(function () {
  ...
  angular
    .module('minesweeper')
    .controller('MinesweeperGameController', MinesweeperGameController);

  /**
	 * 0 - hidden empty 1 - hidden mine 2 - revealed empty 3 - revealed mine 4 -
	 * missed empty
	 * 
	 */
  function MinesweeperGameController($scope, $http, $window) {
    $scope.alive = "";
    $scope.side = 8;
    $scope.moveCount = 0;
    $scope.totalCount = 60;
